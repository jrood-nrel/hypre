...
NALU_HYPRE_Int nalu_hypre_ADSSetInterpolations ( void *solver, nalu_hypre_ParCSRMatrix *RT_Pi,
                                       nalu_hypre_ParCSRMatrix *RT_Pix, nalu_hypre_ParCSRMatrix *RT_Piy,
                                       nalu_hypre_ParCSRMatrix *RT_Piz, nalu_hypre_ParCSRMatrix *ND_Pi,
                                       nalu_hypre_ParCSRMatrix *ND_Pix, nalu_hypre_ParCSRMatrix *ND_Piy,
...
NALU_HYPRE_Int nalu_hypre_AMESetMaxPCGIter ( void *esolver, NALU_HYPRE_Int maxit );
...
NALU_HYPRE_Int NALU_HYPRE_AMESetMaxPCGIter ( NALU_HYPRE_Solver esolver, NALU_HYPRE_Int maxit );
...
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIAlgoType ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int algo_type );
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAILocalSolveType ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int local_solve_type );
...
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIMaxNnzRow ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int max_nnz_row );
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAINumLevels ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int num_levels );
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIEigMaxIters ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int eig_max_iters );
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIThreshold ( NALU_HYPRE_Solver solver, NALU_HYPRE_Real threshold );
...
NALU_HYPRE_Int NALU_HYPRE_FSAISetLocalSolveType ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int local_solve_type );
NALU_HYPRE_Int NALU_HYPRE_FSAIGetLocalSolveType ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int *local_solve_type );
...
NALU_HYPRE_Int NALU_HYPRE_FSAISetMaxNnzRow ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int max_nnz_row );
NALU_HYPRE_Int NALU_HYPRE_FSAIGetMaxNnzRow ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int *max_nnz_row );
NALU_HYPRE_Int NALU_HYPRE_FSAISetNumLevels ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int num_levels );
NALU_HYPRE_Int NALU_HYPRE_FSAIGetNumLevels ( NALU_HYPRE_Solver solver, NALU_HYPRE_Int *num_levels );
NALU_HYPRE_Int NALU_HYPRE_FSAISetThreshold ( NALU_HYPRE_Solver solver, NALU_HYPRE_Real threshold );
NALU_HYPRE_Int NALU_HYPRE_FSAIGetThreshold ( NALU_HYPRE_Solver solver, NALU_HYPRE_Real *threshold );
...
NALU_HYPRE_Int nalu_hypre_BoomerAMGSetFSAIAlgoType ( void *data, NALU_HYPRE_Int fsai_algo_type );
NALU_HYPRE_Int nalu_hypre_BoomerAMGSetFSAILocalSolveType ( void *data, NALU_HYPRE_Int local_solve_type );
...
NALU_HYPRE_Int nalu_hypre_BoomerAMGSetFSAIMaxNnzRow ( void *data, NALU_HYPRE_Int fsai_max_nnz_row );
NALU_HYPRE_Int nalu_hypre_BoomerAMGSetFSAINumLevels ( void *data, NALU_HYPRE_Int fsai_num_levels );
NALU_HYPRE_Int nalu_hypre_BoomerAMGSetFSAIEigMaxIters ( void *data, NALU_HYPRE_Int fsai_eig_max_iters );
NALU_HYPRE_Int nalu_hypre_BoomerAMGSetFSAIThreshold ( void *data, NALU_HYPRE_Real fsai_threshold );
...
/* par_lr_interp.c */
NALU_HYPRE_Int hypreDevice_extendWtoP ( NALU_HYPRE_Int P_nr_of_rows, NALU_HYPRE_Int W_nr_of_rows,
                                   NALU_HYPRE_Int W_nr_of_cols, NALU_HYPRE_Int *CF_marker,
                                   NALU_HYPRE_Int  W_diag_nnz, NALU_HYPRE_Int *W_diag_i,
                                   NALU_HYPRE_Int *W_diag_j, NALU_HYPRE_Complex *W_diag_data,
                                   NALU_HYPRE_Int *P_diag_i, NALU_HYPRE_Int *P_diag_j,
                                   NALU_HYPRE_Complex *P_diag_data, NALU_HYPRE_Int *W_offd_i,
...
NALU_HYPRE_Int nalu_hypre_BoomerAMGBuildStdInterp ( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *CF_marker,
                                          ...
                                          NALU_HYPRE_Int debug_flag, NALU_HYPRE_Real trunc_factor,
                                          NALU_HYPRE_Int max_elmts, NALU_HYPRE_Int sep_weight,
                                          nalu_hypre_ParCSRMatrix **P_ptr );
...
NALU_HYPRE_Int nalu_hypre_BoomerAMGRelaxHybridSOR( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                         NALU_HYPRE_Int *cf_marker, NALU_HYPRE_Int relax_points, NALU_HYPRE_Real relax_weight, NALU_HYPRE_Real omega,
                                         NALU_HYPRE_Real *l1_norms, nalu_hypre_ParVector *u, nalu_hypre_ParVector *Vtemp, nalu_hypre_ParVector *Ztemp,
                                         NALU_HYPRE_Int direction, NALU_HYPRE_Int symm, NALU_HYPRE_Int skip_diag, NALU_HYPRE_Int force_seq );
...
NALU_HYPRE_Int nalu_hypre_BoomerAMGRelaxComputeL1Norms( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int relax_type,
                                              NALU_HYPRE_Int relax_order, NALU_HYPRE_Int coarsest_lvl,
...
void *nalu_hypre_MGRCreateFrelaxVcycleData( void );
NALU_HYPRE_Int nalu_hypre_MGRDestroyFrelaxVcycleData( void *mgr_vdata );
void *nalu_hypre_MGRCreateGSElimData( void );
...
NALU_HYPRE_Int nalu_hypre_MGRCoarsen( nalu_hypre_ParCSRMatrix *S, nalu_hypre_ParCSRMatrix *A,
                            NALU_HYPRE_Int final_coarse_size, NALU_HYPRE_Int *final_coarse_indexes,
                            NALU_HYPRE_Int debug_flag, nalu_hypre_IntArray **CF_marker,
                            NALU_HYPRE_Int last_level );
...
NALU_HYPRE_Int nalu_hypre_MGRBuildP( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *CF_marker,
                           NALU_HYPRE_BigInt *num_cpts_global, NALU_HYPRE_Int method,
                           NALU_HYPRE_Int debug_flag, nalu_hypre_ParCSRMatrix **P_ptr );
NALU_HYPRE_Int nalu_hypre_MGRBuildInterp( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *A_FF,
                                nalu_hypre_ParCSRMatrix *A_FC, NALU_HYPRE_Int *CF_marker,
                                nalu_hypre_ParCSRMatrix *S, NALU_HYPRE_BigInt *num_cpts_global,
                                NALU_HYPRE_Int num_functions, NALU_HYPRE_Int *dof_func,
                                NALU_HYPRE_Int debug_flag, NALU_HYPRE_Real trunc_factor,
                                NALU_HYPRE_Int max_elmts, NALU_HYPRE_Int block_jacobi_bsize,
                                nalu_hypre_ParCSRMatrix  **P, NALU_HYPRE_Int method,
                                NALU_HYPRE_Int numsweeps );
NALU_HYPRE_Int nalu_hypre_MGRBuildPFromWp( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *Wp,
                                 NALU_HYPRE_Int *CF_marker, NALU_HYPRE_Int debug_flag,
                                 nalu_hypre_ParCSRMatrix **P_ptr );
NALU_HYPRE_Int nalu_hypre_MGRBuildPFromWpHost( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *Wp,
                                     NALU_HYPRE_Int *CF_marker, NALU_HYPRE_Int debug_flag,
                                     nalu_hypre_ParCSRMatrix **P_ptr );
NALU_HYPRE_Int nalu_hypre_MGRBuildPBlockJacobi( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *A_FF,
                                      nalu_hypre_ParCSRMatrix *A_FC, nalu_hypre_ParCSRMatrix *Wp,
                                      NALU_HYPRE_Int blk_size, NALU_HYPRE_Int *CF_marker,
                                      NALU_HYPRE_BigInt *cpts_starts, NALU_HYPRE_Int debug_flag,
                                      nalu_hypre_ParCSRMatrix **P_ptr );
NALU_HYPRE_Int nalu_hypre_MGRBuildBlockJacobiWp( nalu_hypre_ParCSRMatrix *A_FF, nalu_hypre_ParCSRMatrix *A_FC,
                                       NALU_HYPRE_Int blk_size, NALU_HYPRE_Int *CF_marker,
                                       NALU_HYPRE_BigInt *cpts_starts_in,
                                       nalu_hypre_ParCSRMatrix **Wp_ptr );
NALU_HYPRE_Int nalu_hypre_MGRBuildRestrict( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *A_FF,
                                  nalu_hypre_ParCSRMatrix *A_FC, NALU_HYPRE_Int *CF_marker,
                                  NALU_HYPRE_BigInt *num_cpts_global, NALU_HYPRE_Int num_functions,
                                  NALU_HYPRE_Int *dof_func, NALU_HYPRE_Int debug_flag,
                                  NALU_HYPRE_Real trunc_factor, NALU_HYPRE_Int max_elmts,
                                  NALU_HYPRE_Real strong_threshold, NALU_HYPRE_Real max_row_sum,
                                  NALU_HYPRE_Int blk_size, nalu_hypre_ParCSRMatrix **RT,
                                  NALU_HYPRE_Int method, NALU_HYPRE_Int numsweeps );
NALU_HYPRE_Int nalu_hypre_ParCSRMatrixExtractBlockDiagHost( nalu_hypre_ParCSRMatrix *par_A, NALU_HYPRE_Int blk_size,
                                                  NALU_HYPRE_Int num_points, NALU_HYPRE_Int point_type,
                                                  NALU_HYPRE_Int *CF_marker, NALU_HYPRE_Int diag_size,
                                                  NALU_HYPRE_Int diag_type, NALU_HYPRE_Real *diag_data );
NALU_HYPRE_Int nalu_hypre_ParCSRMatrixBlockDiagMatrix( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int blk_size,
                                             ...
                                             NALU_HYPRE_Int diag_type, nalu_hypre_ParCSRMatrix **B_ptr );
NALU_HYPRE_Int nalu_hypre_ParCSRMatrixBlockDiagMatrixHost( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int blk_size,
                                                 NALU_HYPRE_Int point_type, NALU_HYPRE_Int *CF_marker,
                                                 NALU_HYPRE_Int diag_type,
                                                 nalu_hypre_ParCSRMatrix **B_ptr );
NALU_HYPRE_Int nalu_hypre_MGRSetCoarseSolver( void *mgr_vdata,
                                    NALU_HYPRE_Int (*cgrid_solver_solve)(void*, void*, void*, void*),
                                    NALU_HYPRE_Int (*cgrid_solver_setup)(void*, void*, void*, void*),
                                    void *coarse_grid_solver );
NALU_HYPRE_Int nalu_hypre_MGRSetFSolver( void *mgr_vdata,
                               NALU_HYPRE_Int (*fine_grid_solver_solve)(void*, void*, void*, void*),
                               NALU_HYPRE_Int (*fine_grid_solver_setup)(void*, void*, void*, void*),
                               void *fsolver );
NALU_HYPRE_Int nalu_hypre_MGRSetup( void *mgr_vdata, nalu_hypre_ParCSRMatrix *A,
                          nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_MGRSolve( void *mgr_vdata, nalu_hypre_ParCSRMatrix *A,
                          nalu_hypre_ParVector *f, nalu_hypre_ParVector  *u );
...
NALU_HYPRE_Int nalu_hypre_MGRBlockRelaxSolveDevice( nalu_hypre_ParCSRMatrix *B, nalu_hypre_ParCSRMatrix *A,
                                          nalu_hypre_ParVector *f, nalu_hypre_ParVector *u,
                                          nalu_hypre_ParVector *Vtemp, NALU_HYPRE_Real relax_weight );
NALU_HYPRE_Int nalu_hypre_MGRBlockRelaxSolve( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                    nalu_hypre_ParVector *u, NALU_HYPRE_Int blk_size,
                                    NALU_HYPRE_Int n_block, NALU_HYPRE_Int left_size,
                                    NALU_HYPRE_Int method, NALU_HYPRE_Real *diaginv,
                                    nalu_hypre_ParVector *Vtemp );
...
//                           nalu_hypre_ParVector *Ztemp);
NALU_HYPRE_Int nalu_hypre_block_jacobi_solve( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                    nalu_hypre_ParVector *u, NALU_HYPRE_Int blk_size,
                                    NALU_HYPRE_Int method, NALU_HYPRE_Real *diaginv,
                                    nalu_hypre_ParVector *Vtemp );
...
NALU_HYPRE_Int nalu_hypre_MGRGetSubBlock( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *row_cf_marker,
                                NALU_HYPRE_Int *col_cf_marker, NALU_HYPRE_Int debug_flag,
...
NALU_HYPRE_Int nalu_hypre_MGRAddVectorP( nalu_hypre_IntArray *CF_marker, NALU_HYPRE_Int point_type, NALU_HYPRE_Real a,
                               nalu_hypre_ParVector *fromVector, NALU_HYPRE_Real b,
...
NALU_HYPRE_Int nalu_hypre_MGRAddVectorR( nalu_hypre_IntArray *CF_marker, NALU_HYPRE_Int point_type, NALU_HYPRE_Real a,
                               nalu_hypre_ParVector *fromVector, NALU_HYPRE_Real b,
                               nalu_hypre_ParVector **toVector );
NALU_HYPRE_Int nalu_hypre_MGRTruncateAcfCPRDevice( nalu_hypre_ParCSRMatrix  *A_CF,
                                         nalu_hypre_ParCSRMatrix **A_CF_new_ptr );
NALU_HYPRE_Int nalu_hypre_MGRTruncateAcfCPR( nalu_hypre_ParCSRMatrix *A_CF, nalu_hypre_ParCSRMatrix **A_CF_new_ptr );
NALU_HYPRE_Int nalu_hypre_MGRComputeNonGalerkinCoarseGrid( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *P,
                                                 nalu_hypre_ParCSRMatrix *RT, NALU_HYPRE_Int bsize,
                                                 NALU_HYPRE_Int ordering, NALU_HYPRE_Int method,
                                                 NALU_HYPRE_Int Pmax, NALU_HYPRE_Int *CF_marker,
...
NALU_HYPRE_Int nalu_hypre_MGRDirectSolverSetup( void *solver, nalu_hypre_ParCSRMatrix *A,
                                      nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_MGRDirectSolverSolve( void *solver, nalu_hypre_ParCSRMatrix *A,
                                      nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
...
/* par_mgr_coarsen.c */
NALU_HYPRE_Int nalu_hypre_MGRCoarseParms( MPI_Comm comm, NALU_HYPRE_Int num_rows, nalu_hypre_IntArray *CF_marker,
                                NALU_HYPRE_BigInt *row_starts_cpts, NALU_HYPRE_BigInt *row_starts_fpts );

/* par_mgr_device.c */
NALU_HYPRE_Int nalu_hypre_MGRRelaxL1JacobiDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                        NALU_HYPRE_Int *CF_marker_host, NALU_HYPRE_Int relax_points,
                                        NALU_HYPRE_Real relax_weight, NALU_HYPRE_Real *l1_norms,
                                        nalu_hypre_ParVector *u, nalu_hypre_ParVector *Vtemp );
NALU_HYPRE_Int nalu_hypre_MGRBuildPFromWpDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix *Wp,
                                       NALU_HYPRE_Int *CF_marker, nalu_hypre_ParCSRMatrix **P_ptr);
NALU_HYPRE_Int nalu_hypre_MGRBuildPDevice( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *CF_marker,
                                 NALU_HYPRE_BigInt *num_cpts_global, NALU_HYPRE_Int method,
                                 nalu_hypre_ParCSRMatrix **P_ptr );
NALU_HYPRE_Int nalu_hypre_ParCSRMatrixExtractBlockDiagDevice( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int blk_size,
                                                    NALU_HYPRE_Int num_points, NALU_HYPRE_Int point_type,
                                                    NALU_HYPRE_Int *CF_marker, NALU_HYPRE_Int diag_size,
                                                    NALU_HYPRE_Int diag_type, NALU_HYPRE_Int *B_diag_i,
                                                    NALU_HYPRE_Int *B_diag_j,
                                                    NALU_HYPRE_Complex *B_diag_data );
NALU_HYPRE_Int nalu_hypre_ParCSRMatrixBlockDiagMatrixDevice( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int blk_size,
                                                   NALU_HYPRE_Int point_type, NALU_HYPRE_Int *CF_marker,
                                                   NALU_HYPRE_Int diag_type,
                                                   nalu_hypre_ParCSRMatrix **B_ptr );
NALU_HYPRE_Int nalu_hypre_MGRComputeNonGalerkinCGDevice( nalu_hypre_ParCSRMatrix *A_FF, nalu_hypre_ParCSRMatrix *A_FC,
                                               nalu_hypre_ParCSRMatrix *A_CF, nalu_hypre_ParCSRMatrix *A_CC,
...
NALU_HYPRE_Int nalu_hypre_ILUSetSchurPrecondILUMaxNnzPerRow( void *ilu_vdata,
...
NALU_HYPRE_Int nalu_hypre_ILUSetSchurPrecondTriSolve( void *ilu_vdata, NALU_HYPRE_Int sp_tri_solve );
NALU_HYPRE_Int nalu_hypre_ILUSetSchurPrecondLowerJacobiIters( void *ilu_vdata,
                                                    NALU_HYPRE_Int sp_lower_jacobi_iters );
NALU_HYPRE_Int nalu_hypre_ILUSetSchurPrecondUpperJacobiIters( void *ilu_vdata,
...
NALU_HYPRE_Int nalu_hypre_ILUMinHeapAddIIIi( NALU_HYPRE_Int *heap, NALU_HYPRE_Int *I1,
                                   NALU_HYPRE_Int *Ii1, NALU_HYPRE_Int len );
NALU_HYPRE_Int nalu_hypre_ILUMinHeapAddIRIi( NALU_HYPRE_Int *heap, NALU_HYPRE_Real *I1,
                                   NALU_HYPRE_Int *Ii1, NALU_HYPRE_Int len );
...
NALU_HYPRE_Int nalu_hypre_ILUMinHeapRemoveIIIi( NALU_HYPRE_Int *heap, NALU_HYPRE_Int *I1,
                                      NALU_HYPRE_Int *Ii1, NALU_HYPRE_Int len );
NALU_HYPRE_Int nalu_hypre_ILUMinHeapRemoveIRIi( NALU_HYPRE_Int *heap, NALU_HYPRE_Real *I1,
                                      NALU_HYPRE_Int *Ii1, NALU_HYPRE_Int len );
NALU_HYPRE_Int nalu_hypre_ILUMaxrHeapRemoveRabsI( NALU_HYPRE_Real *heap, NALU_HYPRE_Int *I1, NALU_HYPRE_Int len );
NALU_HYPRE_Int nalu_hypre_ILUMaxQSplitRabsI( NALU_HYPRE_Real *arrayR, NALU_HYPRE_Int *arrayI, NALU_HYPRE_Int left,
                                   NALU_HYPRE_Int bound, NALU_HYPRE_Int right );
NALU_HYPRE_Int nalu_hypre_ILUMaxRabs( NALU_HYPRE_Real *array_data, NALU_HYPRE_Int *array_j, NALU_HYPRE_Int start,
                            NALU_HYPRE_Int end, NALU_HYPRE_Int nLU, NALU_HYPRE_Int *rperm, NALU_HYPRE_Real *value,
                            NALU_HYPRE_Int *index, NALU_HYPRE_Real *l1_norm, NALU_HYPRE_Int *nnz );

NALU_HYPRE_Int nalu_hypre_ILUGetPermddPQPre( NALU_HYPRE_Int n, NALU_HYPRE_Int nLU, NALU_HYPRE_Int *A_diag_i,
                                   NALU_HYPRE_Int *A_diag_j, NALU_HYPRE_Real *A_diag_data,
                                   NALU_HYPRE_Real tol, NALU_HYPRE_Int *perm, NALU_HYPRE_Int *rperm,
                                   NALU_HYPRE_Int *pperm_pre, NALU_HYPRE_Int *qperm_pre, NALU_HYPRE_Int *nB );
NALU_HYPRE_Int nalu_hypre_ILUGetPermddPQ( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int **io_pperm, NALU_HYPRE_Int **io_qperm,
                                NALU_HYPRE_Real tol, NALU_HYPRE_Int *nB, NALU_HYPRE_Int *nI,
                                NALU_HYPRE_Int reordering_type );
NALU_HYPRE_Int nalu_hypre_ILUGetInteriorExteriorPerm( nalu_hypre_ParCSRMatrix *A,
                                            NALU_HYPRE_MemoryLocation memory_location,
                                            NALU_HYPRE_Int **perm, NALU_HYPRE_Int *nLU,
                                            NALU_HYPRE_Int reordering_type );
NALU_HYPRE_Int nalu_hypre_ILUGetLocalPerm( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int **perm_ptr,
                                 NALU_HYPRE_Int *nLU, NALU_HYPRE_Int reordering_type );
NALU_HYPRE_Int nalu_hypre_ILUBuildRASExternalMatrix( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *rperm,
                                           NALU_HYPRE_Int **E_i, NALU_HYPRE_Int **E_j, NALU_HYPRE_Real **E_data );
NALU_HYPRE_Int nalu_hypre_ILUSortOffdColmap( nalu_hypre_ParCSRMatrix *A );
NALU_HYPRE_Int nalu_hypre_ILULocalRCMBuildFinalPerm( NALU_HYPRE_Int start, NALU_HYPRE_Int end,
                                           NALU_HYPRE_Int * G_perm, NALU_HYPRE_Int *perm, NALU_HYPRE_Int *qperm,
                                           NALU_HYPRE_Int **permp, NALU_HYPRE_Int **qpermp );
NALU_HYPRE_Int nalu_hypre_ILULocalRCM( nalu_hypre_CSRMatrix *A, NALU_HYPRE_Int start, NALU_HYPRE_Int end,
                             NALU_HYPRE_Int **permp, NALU_HYPRE_Int **qpermp, NALU_HYPRE_Int sym );
NALU_HYPRE_Int nalu_hypre_ILULocalRCMMindegree( NALU_HYPRE_Int n, NALU_HYPRE_Int *degree,
                                      NALU_HYPRE_Int *marker, NALU_HYPRE_Int *rootp );
...
NALU_HYPRE_Int nalu_hypre_ParILUSchurGMRESDummySolveDevice( void *ilu_vdata, void *ilu_vdata2,
                                                  nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_ParILUSchurGMRESCommInfoDevice( void *ilu_vdata, NALU_HYPRE_Int *my_id,
                                                NALU_HYPRE_Int *num_procs );
NALU_HYPRE_Int nalu_hypre_ParILURAPSchurGMRESSolveDevice( void *ilu_vdata, void *ilu_vdata2,
                                                nalu_hypre_ParVector *par_f, nalu_hypre_ParVector *par_u );
NALU_HYPRE_Int nalu_hypre_ParILURAPSchurGMRESMatvecDevice( void *matvec_data, NALU_HYPRE_Complex alpha,
                                                 void *ilu_vdata, void *x,
                                                 NALU_HYPRE_Complex beta, void *y );
#endif
NALU_HYPRE_Int nalu_hypre_ParILURAPSchurGMRESCommInfoHost( void *ilu_vdata, NALU_HYPRE_Int *my_id,
                                                 NALU_HYPRE_Int *num_procs );
NALU_HYPRE_Int nalu_hypre_ParILURAPSchurGMRESSolveHost( void *ilu_vdata, void *ilu_vdata2,
                                              nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_ParILURAPSchurGMRESMatvecHost( void *matvec_data, NALU_HYPRE_Complex alpha,
                                               void *ilu_vdata, void *x,
                                               NALU_HYPRE_Complex beta, void *y );

void * nalu_hypre_NSHCreate( void );
...
NALU_HYPRE_Int nalu_hypre_CSRMatrixDropInplace( nalu_hypre_CSRMatrix *A, NALU_HYPRE_Real droptol,
                                      NALU_HYPRE_Int max_row_nnz );
NALU_HYPRE_Int nalu_hypre_ILUCSRMatrixInverseSelfPrecondMRGlobal( nalu_hypre_CSRMatrix *matA,
                                                        nalu_hypre_CSRMatrix **M,
                                                        NALU_HYPRE_Real droptol, NALU_HYPRE_Real tol,
                                                        NALU_HYPRE_Real eps_tol, NALU_HYPRE_Int max_row_nnz,
                                                        NALU_HYPRE_Int max_iter,
                                                        NALU_HYPRE_Int print_level );
NALU_HYPRE_Int nalu_hypre_ILUParCSRInverseNSH( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParCSRMatrix **M,
                                     NALU_HYPRE_Real *droptol, NALU_HYPRE_Real mr_tol,
                                     NALU_HYPRE_Real nsh_tol, NALU_HYPRE_Real eps_tol,
                                     NALU_HYPRE_Int mr_max_row_nnz, NALU_HYPRE_Int nsh_max_row_nnz,
                                     NALU_HYPRE_Int mr_max_iter, NALU_HYPRE_Int nsh_max_iter,
                                     NALU_HYPRE_Int mr_col_version, NALU_HYPRE_Int print_level );

/* par_ilu_setup.c */
NALU_HYPRE_Int nalu_hypre_ILUSetup( void *ilu_vdata, nalu_hypre_ParCSRMatrix *A,
                          nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_ParILUExtractEBFC( nalu_hypre_CSRMatrix *A_diag, NALU_HYPRE_Int nLU,
                                   nalu_hypre_CSRMatrix **Bp, nalu_hypre_CSRMatrix **Cp,
                                   nalu_hypre_CSRMatrix **Ep, nalu_hypre_CSRMatrix **Fp );
NALU_HYPRE_Int nalu_hypre_ParILURAPReorder( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *perm,
                                  NALU_HYPRE_Int *rqperm, nalu_hypre_ParCSRMatrix **A_pq );
NALU_HYPRE_Int nalu_hypre_ILUSetupLDUtoCusparse( nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D,
                                       nalu_hypre_ParCSRMatrix  *U, nalu_hypre_ParCSRMatrix **LDUp );
...
NALU_HYPRE_Int nalu_hypre_ILUSetupRAPILU0Device( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *perm, NALU_HYPRE_Int n,
                                       NALU_HYPRE_Int nLU, nalu_hypre_ParCSRMatrix **Apermptr,
                                       nalu_hypre_ParCSRMatrix **matSptr, nalu_hypre_CSRMatrix **ALUptr,
                                       nalu_hypre_CSRMatrix **BLUptr, nalu_hypre_CSRMatrix **CLUptr,
                                       nalu_hypre_CSRMatrix **Eptr, nalu_hypre_CSRMatrix **Fptr,
                                       NALU_HYPRE_Int test_opt );
NALU_HYPRE_Int nalu_hypre_ILUSetupRAPILU0( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *perm, NALU_HYPRE_Int n,
                                 NALU_HYPRE_Int nLU, nalu_hypre_ParCSRMatrix **Lptr, NALU_HYPRE_Real **Dptr,
                                 nalu_hypre_ParCSRMatrix **Uptr, nalu_hypre_ParCSRMatrix **mLptr,
                                 NALU_HYPRE_Real **mDptr, nalu_hypre_ParCSRMatrix **mUptr,
...
NALU_HYPRE_Int nalu_hypre_ILUSetupILU0( nalu_hypre_ParCSRMatrix  *A, NALU_HYPRE_Int *perm, NALU_HYPRE_Int *qperm,
                              NALU_HYPRE_Int nLU, NALU_HYPRE_Int nI, nalu_hypre_ParCSRMatrix **Lptr,
                              NALU_HYPRE_Real **Dptr, nalu_hypre_ParCSRMatrix **Uptr,
                              nalu_hypre_ParCSRMatrix **Sptr, NALU_HYPRE_Int **u_end );
NALU_HYPRE_Int nalu_hypre_ILUSetupMILU0( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *permp,
                               NALU_HYPRE_Int *qpermp, NALU_HYPRE_Int nLU, NALU_HYPRE_Int nI,
                               nalu_hypre_ParCSRMatrix **Lptr, NALU_HYPRE_Real **Dptr,
                               nalu_hypre_ParCSRMatrix **Uptr, nalu_hypre_ParCSRMatrix **Sptr,
                               NALU_HYPRE_Int **u_end, NALU_HYPRE_Int modified );
NALU_HYPRE_Int nalu_hypre_ILUSetupILUKSymbolic( NALU_HYPRE_Int n, NALU_HYPRE_Int *A_diag_i, NALU_HYPRE_Int *A_diag_j,
                                      NALU_HYPRE_Int lfil, NALU_HYPRE_Int *perm, NALU_HYPRE_Int *rperm,
                                      NALU_HYPRE_Int *iw, NALU_HYPRE_Int nLU, NALU_HYPRE_Int *L_diag_i,
                                      NALU_HYPRE_Int *U_diag_i, NALU_HYPRE_Int *S_diag_i,
                                      NALU_HYPRE_Int **L_diag_j, NALU_HYPRE_Int **U_diag_j,
                                      NALU_HYPRE_Int **S_diag_j, NALU_HYPRE_Int **u_end );
...
NALU_HYPRE_Int nalu_hypre_ILUSetupILUT( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int lfil, NALU_HYPRE_Real *tol,
                              NALU_HYPRE_Int *permp, NALU_HYPRE_Int *qpermp, NALU_HYPRE_Int nLU,
                              NALU_HYPRE_Int nI, nalu_hypre_ParCSRMatrix **Lptr, NALU_HYPRE_Real **Dptr,
                              nalu_hypre_ParCSRMatrix **Uptr, nalu_hypre_ParCSRMatrix **Sptr,
                              NALU_HYPRE_Int **u_end );
NALU_HYPRE_Int nalu_hypre_NSHSetup( void *nsh_vdata, nalu_hypre_ParCSRMatrix *A,
                          nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_ILUSetupILU0RAS( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int *perm,
                                 NALU_HYPRE_Int nLU, nalu_hypre_ParCSRMatrix **Lptr,
                                 NALU_HYPRE_Real **Dptr, nalu_hypre_ParCSRMatrix **Uptr );
NALU_HYPRE_Int nalu_hypre_ILUSetupILUKRASSymbolic( NALU_HYPRE_Int n, NALU_HYPRE_Int *A_diag_i, NALU_HYPRE_Int *A_diag_j,
                                         ...
                                         NALU_HYPRE_Int lfil, NALU_HYPRE_Int *perm, NALU_HYPRE_Int *rperm,
                                         NALU_HYPRE_Int *iw, NALU_HYPRE_Int nLU, NALU_HYPRE_Int *L_diag_i,
                                         NALU_HYPRE_Int *U_diag_i, NALU_HYPRE_Int **L_diag_j,
...
NALU_HYPRE_Int nalu_hypre_ILUSetupILUKRAS( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int lfil, NALU_HYPRE_Int *perm,
                                 NALU_HYPRE_Int nLU, nalu_hypre_ParCSRMatrix **Lptr,
                                 NALU_HYPRE_Real **Dptr, nalu_hypre_ParCSRMatrix **Uptr );
NALU_HYPRE_Int nalu_hypre_ILUSetupILUTRAS( nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_Int lfil,
                                 NALU_HYPRE_Real *tol, NALU_HYPRE_Int *perm, NALU_HYPRE_Int nLU,
                                 nalu_hypre_ParCSRMatrix **Lptr, NALU_HYPRE_Real **Dptr,
                                 nalu_hypre_ParCSRMatrix **Uptr );

/* par_ilu_setup_device.c */
NALU_HYPRE_Int nalu_hypre_ILUSetupILUDevice( NALU_HYPRE_Int ilu_type, nalu_hypre_ParCSRMatrix *A,
                                   NALU_HYPRE_Int lfil, NALU_HYPRE_Real *tol, NALU_HYPRE_Int *perm_data,
                                   NALU_HYPRE_Int *qperm_data, NALU_HYPRE_Int n, NALU_HYPRE_Int nLU,
                                   nalu_hypre_CSRMatrix **BLUptr, nalu_hypre_ParCSRMatrix **matSptr,
                                   nalu_hypre_CSRMatrix **Eptr, nalu_hypre_CSRMatrix **Fptr,
                                   NALU_HYPRE_Int tri_solve );

/* par_ilu_solve.c */
NALU_HYPRE_Int nalu_hypre_ILUSolve( void *ilu_vdata, nalu_hypre_ParCSRMatrix *A,
                          nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_ILUSolveSchurGMRES( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                    nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm,
                                    NALU_HYPRE_Int *qperm, NALU_HYPRE_Int nLU,
                                    nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D,
                                    nalu_hypre_ParCSRMatrix *U, nalu_hypre_ParCSRMatrix *S,
                                    nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp,
                                    NALU_HYPRE_Solver schur_solver, NALU_HYPRE_Solver schur_precond,
                                    nalu_hypre_ParVector *rhs, nalu_hypre_ParVector *x, NALU_HYPRE_Int *u_end );
NALU_HYPRE_Int nalu_hypre_ILUSolveSchurNSH( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                  nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm, NALU_HYPRE_Int nLU,
                                  nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D,
                                  nalu_hypre_ParCSRMatrix *U, nalu_hypre_ParCSRMatrix *S,
                                  nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp,
                                  NALU_HYPRE_Solver schur_solver, nalu_hypre_ParVector *rhs,
                                  nalu_hypre_ParVector *x, NALU_HYPRE_Int *u_end );
NALU_HYPRE_Int nalu_hypre_ILUSolveLU( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                            nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm, NALU_HYPRE_Int nLU,
                            nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D, nalu_hypre_ParCSRMatrix *U,
                            nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp );
NALU_HYPRE_Int nalu_hypre_ILUSolveLUIter( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm, NALU_HYPRE_Int nLU,
                                nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D, nalu_hypre_ParCSRMatrix *U,
                                nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp,
                                nalu_hypre_ParVector *xtemp, NALU_HYPRE_Int lower_jacobi_iters,
...
NALU_HYPRE_Int nalu_hypre_ILUSolveLURAS( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f, nalu_hypre_ParVector *u,
                               NALU_HYPRE_Int *perm, nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D,
                               nalu_hypre_ParCSRMatrix *U, nalu_hypre_ParVector *ftemp,
                               nalu_hypre_ParVector *utemp, NALU_HYPRE_Real *fext, NALU_HYPRE_Real *uext );
NALU_HYPRE_Int nalu_hypre_ILUSolveRAPGMRESHost( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                      nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm, NALU_HYPRE_Int nLU,
                                      nalu_hypre_ParCSRMatrix *L, NALU_HYPRE_Real *D, nalu_hypre_ParCSRMatrix *U,
                                      nalu_hypre_ParCSRMatrix *mL, NALU_HYPRE_Real *mD,
                                      nalu_hypre_ParCSRMatrix *mU, nalu_hypre_ParVector *ftemp,
                                      nalu_hypre_ParVector *utemp, nalu_hypre_ParVector *xtemp,
                                      nalu_hypre_ParVector *ytemp, NALU_HYPRE_Solver schur_solver,
                                      NALU_HYPRE_Solver schur_precond, nalu_hypre_ParVector *rhs,
                                      nalu_hypre_ParVector *x, NALU_HYPRE_Int *u_end );
NALU_HYPRE_Int nalu_hypre_NSHSolve( void *nsh_vdata, nalu_hypre_ParCSRMatrix *A,
                          nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_NSHSolveInverse( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                 nalu_hypre_ParVector *u, nalu_hypre_ParCSRMatrix *M,
                                 nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp );

/* par_ilu_solve_device.c */
#if defined(NALU_HYPRE_USING_CUDA) || defined(NALU_HYPRE_USING_HIP)
NALU_HYPRE_Int nalu_hypre_ILUSolveLUDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_CSRMatrix *matLU_d,
                                  nalu_hypre_ParVector *f, nalu_hypre_ParVector *u,
                                  NALU_HYPRE_Int *perm, nalu_hypre_ParVector *ftemp,
                                  nalu_hypre_ParVector *utemp );
NALU_HYPRE_Int nalu_hypre_ILUApplyLowerJacIterDevice( nalu_hypre_CSRMatrix *A, nalu_hypre_Vector *input,
                                            nalu_hypre_Vector *work, nalu_hypre_Vector *output,
                                            NALU_HYPRE_Int lower_jacobi_iters );
NALU_HYPRE_Int nalu_hypre_ILUApplyUpperJacIterDevice( nalu_hypre_CSRMatrix *A, nalu_hypre_Vector *input,
                                            nalu_hypre_Vector *work, nalu_hypre_Vector *output,
                                            nalu_hypre_Vector *diag, NALU_HYPRE_Int upper_jacobi_iters );
NALU_HYPRE_Int nalu_hypre_ILUApplyLowerUpperJacIterDevice( nalu_hypre_CSRMatrix *A, nalu_hypre_Vector *work1,
                                                 nalu_hypre_Vector *work2, nalu_hypre_Vector *inout,
                                                 nalu_hypre_Vector *diag, NALU_HYPRE_Int lower_jacobi_iters,
                                                 NALU_HYPRE_Int upper_jacobi_iters );
NALU_HYPRE_Int nalu_hypre_ILUSolveLUIterDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_CSRMatrix *matLU,
                                      nalu_hypre_ParVector *f, nalu_hypre_ParVector *u,
                                      NALU_HYPRE_Int *perm, nalu_hypre_ParVector *ftemp,
                                      nalu_hypre_ParVector *utemp, nalu_hypre_ParVector *xtemp,
                                      nalu_hypre_Vector **diag_ptr, NALU_HYPRE_Int lower_jacobi_iters,
                                      NALU_HYPRE_Int upper_jacobi_iters );
NALU_HYPRE_Int nalu_hypre_ParILUSchurGMRESMatvecDevice( void *matvec_data, NALU_HYPRE_Complex alpha,
                                              void *ilu_vdata, void *x,
                                              NALU_HYPRE_Complex beta, void *y );
NALU_HYPRE_Int nalu_hypre_ILUSolveSchurGMRESDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                          nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm,
                                          NALU_HYPRE_Int nLU, nalu_hypre_ParCSRMatrix *S,
                                          nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp,
                                          NALU_HYPRE_Solver schur_solver, NALU_HYPRE_Solver schur_precond,
                                          nalu_hypre_ParVector *rhs, nalu_hypre_ParVector *x,
                                          NALU_HYPRE_Int *u_end, nalu_hypre_CSRMatrix *matBLU_d,
                                          nalu_hypre_CSRMatrix *matE_d, nalu_hypre_CSRMatrix *matF_d );
NALU_HYPRE_Int nalu_hypre_ILUSolveSchurGMRESJacIterDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                                 nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm,
                                                 NALU_HYPRE_Int nLU, nalu_hypre_ParCSRMatrix *S,
                                                 nalu_hypre_ParVector *ftemp, nalu_hypre_ParVector *utemp,
                                                 ...
                                                 NALU_HYPRE_Int lower_jacobi_iters,
                                                 NALU_HYPRE_Int upper_jacobi_iters );
NALU_HYPRE_Int nalu_hypre_ParILUSchurGMRESMatvecJacIterDevice( void *matvec_data, NALU_HYPRE_Complex alpha,
                                                     void *ilu_vdata, void *x, NALU_HYPRE_Complex beta,
                                                     void *y );
NALU_HYPRE_Int nalu_hypre_ILUSolveRAPGMRESDevice( nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                                        nalu_hypre_ParVector *u, NALU_HYPRE_Int *perm, NALU_HYPRE_Int nLU,
                                        nalu_hypre_ParCSRMatrix *S, nalu_hypre_ParVector *ftemp,
                                        nalu_hypre_ParVector *utemp, nalu_hypre_ParVector *xtemp,
                                        nalu_hypre_ParVector *ytemp, NALU_HYPRE_Solver schur_solver,
                                        NALU_HYPRE_Solver schur_precond, nalu_hypre_ParVector *rhs,
                                        nalu_hypre_ParVector *x, NALU_HYPRE_Int *u_end,
                                        nalu_hypre_ParCSRMatrix *Aperm, nalu_hypre_CSRMatrix *matALU_d,
                                        nalu_hypre_CSRMatrix *matBLU_d, nalu_hypre_CSRMatrix *matE_d,
                                        nalu_hypre_CSRMatrix *matF_d, NALU_HYPRE_Int test_opt );
#endif
...
/* par_fsai.c */
void* nalu_hypre_FSAICreate( void );
...
NALU_HYPRE_Int nalu_hypre_FSAISetLocalSolveType ( void *data, NALU_HYPRE_Int local_solve_type );
...
NALU_HYPRE_Int nalu_hypre_FSAISetMaxNnzRow ( void *data, NALU_HYPRE_Int max_nnz_row );
NALU_HYPRE_Int nalu_hypre_FSAISetNumLevels ( void *data, NALU_HYPRE_Int num_levels );
NALU_HYPRE_Int nalu_hypre_FSAISetThreshold ( void *data, NALU_HYPRE_Real threshold );
...
NALU_HYPRE_Int nalu_hypre_FSAIGetLocalSolveType ( void *data, NALU_HYPRE_Int *local_solve_type );
...
NALU_HYPRE_Int nalu_hypre_FSAIGetMaxNnzRow ( void *data, NALU_HYPRE_Int *max_nnz_row );
NALU_HYPRE_Int nalu_hypre_FSAIGetNumLevels ( void *data, NALU_HYPRE_Int *num_levels );
NALU_HYPRE_Int nalu_hypre_FSAIGetThreshold ( void *data, NALU_HYPRE_Real *threshold );
...
NALU_HYPRE_Int nalu_hypre_CSRMatrixExtractDenseMat ( nalu_hypre_CSRMatrix *A, nalu_hypre_Vector *A_sub,
                                           NALU_HYPRE_Int *S_Pattern, NALU_HYPRE_Int S_nnz,
...
NALU_HYPRE_Int nalu_hypre_FindKapGrad ( nalu_hypre_CSRMatrix *A_diag, nalu_hypre_Vector *kaporin_gradient,
                              NALU_HYPRE_Int *kap_grad_nonzeros, nalu_hypre_Vector *G_temp,
                              NALU_HYPRE_Int *S_Pattern, NALU_HYPRE_Int S_nnz,
...
NALU_HYPRE_Int nalu_hypre_AddToPattern ( nalu_hypre_Vector *kaporin_gradient, NALU_HYPRE_Int *kap_grad_nonzeros,
                               NALU_HYPRE_Int *S_Pattern, NALU_HYPRE_Int *S_nnz, NALU_HYPRE_Int *kg_marker,
...
NALU_HYPRE_Int nalu_hypre_FSAISetup ( void *fsai_vdata, nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *f,
                            nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_FSAISetupNative ( void *fsai_vdata, nalu_hypre_ParCSRMatrix *A,
                                  nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
NALU_HYPRE_Int nalu_hypre_FSAISetupOMPDyn ( void *fsai_vdata, nalu_hypre_ParCSRMatrix *A,
                                  nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );
...
NALU_HYPRE_Int nalu_hypre_FSAIDumpLocalLSDense ( void *fsai_vdata, const char *filename,
                                       nalu_hypre_ParCSRMatrix *A );

/* par_fsai_solve.c */
NALU_HYPRE_Int nalu_hypre_FSAISolve ( void *fsai_vdata, nalu_hypre_ParCSRMatrix *A, nalu_hypre_ParVector *b,
                            nalu_hypre_ParVector *x );
NALU_HYPRE_Int nalu_hypre_FSAIApply ( void *fsai_vdata, NALU_HYPRE_Complex alpha, nalu_hypre_ParVector *b,
                            nalu_hypre_ParVector *x );

/* par_fsai_device.c */
NALU_HYPRE_Int nalu_hypre_FSAISetupDevice( void *fsai_vdata, nalu_hypre_ParCSRMatrix *A,
                                 nalu_hypre_ParVector *f, nalu_hypre_ParVector *u );

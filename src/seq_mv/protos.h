...
NALU_HYPRE_Int nalu_hypre_CSRMatrixFixZeroDiagDevice( nalu_hypre_CSRMatrix *A, NALU_HYPRE_Complex v, NALU_HYPRE_Real tol );
...
void nalu_hypre_CSRMatrixComputeRowSumDevice( nalu_hypre_CSRMatrix *A, NALU_HYPRE_Int *CF_i, NALU_HYPRE_Int *CF_j,
                                         NALU_HYPRE_Complex *row_sum, NALU_HYPRE_Int type, NALU_HYPRE_Complex scal, const char *set_or_add);
void nalu_hypre_CSRMatrixExtractDiagonalDevice( nalu_hypre_CSRMatrix *A, NALU_HYPRE_Complex *d, NALU_HYPRE_Int type);
...
NALU_HYPRE_Int nalu_hypre_CSRMatrixTriLowerUpperSolveDevice(char uplo, nalu_hypre_CSRMatrix *A,
                                                  NALU_HYPRE_Real *l1_norms, nalu_hypre_Vector *f, nalu_hypre_Vector *u );
NALU_HYPRE_Int nalu_hypre_CSRMatrixTriLowerUpperSolveRocsparse(char uplo, nalu_hypre_CSRMatrix *A,
                                                     NALU_HYPRE_Real *l1_norms, nalu_hypre_Vector *f, nalu_hypre_Vector *u );
NALU_HYPRE_Int nalu_hypre_CSRMatrixTriLowerUpperSolveCusparse(char uplo, nalu_hypre_CSRMatrix *A,
                                                    NALU_HYPRE_Real *l1_norms, nalu_hypre_Vector *f, nalu_hypre_Vector *u );
...
nalu_hypre_CSRMatrix *nalu_hypre_CSRMatrixClone_v2( nalu_hypre_CSRMatrix *A, NALU_HYPRE_Int copy_data,
                                          NALU_HYPRE_MemoryLocation memory_location );
nalu_hypre_CSRMatrix *nalu_hypre_CSRMatrixUnion ( nalu_hypre_CSRMatrix *A, nalu_hypre_CSRMatrix *B,
...
void nalu_hypre_CsrsvDataDestroy(nalu_hypre_CsrsvData *data);
nalu_hypre_GpuMatData* nalu_hypre_GpuMatDataCreate();
void nalu_hypre_GPUMatDataSetCSRData(nalu_hypre_GpuMatData *data, nalu_hypre_CSRMatrix *matrix);
void nalu_hypre_GpuMatDataDestroy(nalu_hypre_GpuMatData *data);
nalu_hypre_GpuMatData* nalu_hypre_CSRMatrixGetGPUMatData(nalu_hypre_CSRMatrix *matrix);
#define nalu_hypre_CSRMatrixGPUMatDescr(matrix)       ( nalu_hypre_GpuMatDataMatDecsr(nalu_hypre_CSRMatrixGetGPUMatData(matrix)) )

...
#ifdef NALU_HYPRE_FORTRAN
            pdata.vartypes =  hypre_CTAlloc(hypre_F90_Obj,  pdata.nvars, NALU_HYPRE_MEMORY_HOST);
#else
...
#ifdef NALU_HYPRE_FORTRAN
   stencils = hypre_CTAlloc(hypre_F90_Obj,  data.nstencils, NALU_HYPRE_MEMORY_HOST);
#else

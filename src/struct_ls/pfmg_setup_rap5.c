...
/*--------------------------------------------------------------------------
 * nalu_hypre_PFMGCreateCoarseOp5
...
nalu_hypre_PFMGCreateCoarseOp5( nalu_hypre_StructMatrix *R,
...
NALU_HYPRE_Int
nalu_hypre_PFMGBuildCoarseOp5( nalu_hypre_StructMatrix *A,
                          nalu_hypre_StructMatrix *P,

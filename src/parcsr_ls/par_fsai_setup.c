                       ...
                       nalu_hypre_ParVector    *u )
{
   ...
   ***********************************************************************/
...
#endif
   {
      ...
      nalu_hypre_SeqVectorInitialize(G_temp);
      nalu_hypre_SeqVectorInitialize(A_subrow);
      nalu_hypre_SeqVectorInitialize(kap_grad);
      nalu_hypre_SeqVectorInitialize(A_sub);
                        ...
                        nalu_hypre_ParCSRMatrix *A )
{
   ...
   nalu_hypre_ParVectorInitialize(eigvec_old);
   eigvec = nalu_hypre_ParVectorCreate(nalu_hypre_ParCSRMatrixComm(A),
                                  nalu_hypre_ParCSRMatrixGlobalNumRows(A),
                                  nalu_hypre_ParCSRMatrixRowStarts(A));
   nalu_hypre_ParVectorInitialize(eigvec);

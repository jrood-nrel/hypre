...
/*--------------------------------------------------------------------------
 * NALU_HYPRE_BoomerAMGSetFSAIAlgoType
 *--------------------------------------------------------------------------*/

NALU_HYPRE_Int
NALU_HYPRE_BoomerAMGSetFSAIAlgoType( NALU_HYPRE_Solver  solver,
                                NALU_HYPRE_Int     algo_type )
{
   return ( nalu_hypre_BoomerAMGSetFSAIAlgoType( (void *) solver, algo_type ) );
}

/*--------------------------------------------------------------------------
 * NALU_HYPRE_BoomerAMGSetFSAILocalSolveType
 *--------------------------------------------------------------------------*/

NALU_HYPRE_Int
NALU_HYPRE_BoomerAMGSetFSAILocalSolveType( NALU_HYPRE_Solver  solver,
                                      NALU_HYPRE_Int     local_solve_type )
{
   return ( nalu_hypre_BoomerAMGSetFSAILocalSolveType( (void *) solver, local_solve_type ) );
}
...
/*--------------------------------------------------------------------------
 * NALU_HYPRE_BoomerAMGSetFSAIMaxNnzRow
 *--------------------------------------------------------------------------*/

NALU_HYPRE_Int
NALU_HYPRE_BoomerAMGSetFSAIMaxNnzRow( NALU_HYPRE_Solver  solver,
                                 NALU_HYPRE_Int     max_nnz_row )
{
   return ( nalu_hypre_BoomerAMGSetFSAIMaxNnzRow( (void *) solver, max_nnz_row ) );
}

/*--------------------------------------------------------------------------
 * NALU_HYPRE_BoomerAMGSetFSAINumLevels
 *--------------------------------------------------------------------------*/

NALU_HYPRE_Int
NALU_HYPRE_BoomerAMGSetFSAINumLevels( NALU_HYPRE_Solver  solver,
                                 NALU_HYPRE_Int     num_levels )
{
   return ( nalu_hypre_BoomerAMGSetFSAINumLevels( (void *) solver, num_levels ) );
}

/*--------------------------------------------------------------------------
 * NALU_HYPRE_BoomerAMGSetFSAIThreshold
 *--------------------------------------------------------------------------*/

NALU_HYPRE_Int
NALU_HYPRE_BoomerAMGSetFSAIThreshold( NALU_HYPRE_Solver  solver,
                                 NALU_HYPRE_Real    threshold )
{
   return ( nalu_hypre_BoomerAMGSetFSAIThreshold( (void *) solver, threshold ) );
}

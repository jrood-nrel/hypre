...
/******************************************************************************
 *
 * Header file for NALU_HYPRE BLAS
 *
 *****************************************************************************/
...
#define nalu_hypre_dasum   nalu_hypre_F90_NAME_BLAS(sasum ,SASUM )
#define nalu_hypre_daxpy   nalu_hypre_F90_NAME_BLAS(saxpy ,SAXPY )
#define nalu_hypre_dcopy   nalu_hypre_F90_NAME_BLAS(scopy ,SCOPY )
#define nalu_hypre_ddot    nalu_hypre_F90_NAME_BLAS(sdot  ,SDOT  )
#define nalu_hypre_dgemm   nalu_hypre_F90_NAME_BLAS(sgemm ,SGEMM )
#define nalu_hypre_dgemv   nalu_hypre_F90_NAME_BLAS(sgemv ,SGEMV )
#define nalu_hypre_dger    nalu_hypre_F90_NAME_BLAS(sger  ,SGER  )
#define nalu_hypre_dnrm2   nalu_hypre_F90_NAME_BLAS(snrm2 ,SNRM2 )
#define nalu_hypre_drot    nalu_hypre_F90_NAME_BLAS(srot  ,SROT  )
#define nalu_hypre_dscal   nalu_hypre_F90_NAME_BLAS(sscal ,SSCAL )
#define nalu_hypre_dswap   nalu_hypre_F90_NAME_BLAS(sswap ,SSWAP )
#define nalu_hypre_dsymm   nalu_hypre_F90_NAME_BLAS(ssymm ,SSYMM )
#define nalu_hypre_dsymv   nalu_hypre_F90_NAME_BLAS(ssymv ,SSYMV )
#define nalu_hypre_dsyr2   nalu_hypre_F90_NAME_BLAS(ssyr2 ,SSYR2 )
#define nalu_hypre_dsyr2k  nalu_hypre_F90_NAME_BLAS(ssyr2k,SSYR2K)
#define nalu_hypre_dsyrk   nalu_hypre_F90_NAME_BLAS(ssyrk ,SSYRK )
#define nalu_hypre_dtrmm   nalu_hypre_F90_NAME_BLAS(strmm ,STRMM )
#define nalu_hypre_dtrmv   nalu_hypre_F90_NAME_BLAS(strmv ,STRMV )
#define nalu_hypre_dtrsm   nalu_hypre_F90_NAME_BLAS(strsm ,STRSM )
#define nalu_hypre_dtrsv   nalu_hypre_F90_NAME_BLAS(strsv ,STRSV )
#define nalu_hypre_idamax  nalu_hypre_F90_NAME_BLAS(isamax,ISAMAX)
#else

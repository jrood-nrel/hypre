                               ...
                               NALU_HYPRE_Complex     **d_c_out)
{
   ...
   NALU_HYPRE_ROCSPARSE_CALL( hypre_rocsparse_csrgemm_buffer_size(handle,
                                                             transA, transB,
                                                             m, n, k,
                                                             &alpha, // \alpha = 1
   ...
   rs_buffer = hypre_TAlloc(char, rs_buffer_size, NALU_HYPRE_MEMORY_DEVICE);
   ...
   NALU_HYPRE_ROCSPARSE_CALL( hypre_rocsparse_csrgemm(handle, transA, transB,
                                                 m, n, k,
                                                 &alpha, // alpha = 1
   ...
   hypre_TFree(rs_buffer, NALU_HYPRE_MEMORY_DEVICE);

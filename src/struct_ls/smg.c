...
hypre_SMGCreate( MPI_Comm  comm )
{
   ...
   smg_data = hypre_CTAlloc(hypre_SMGData, 1, NALU_HYPRE_MEMORY_HOST);
...
hypre_SMGDestroy( void *smg_vdata )
{
   ...
   if (smg_data)
   {
      ...
      {
         hypre_TFree(smg_data -> norms, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> rel_norms, NALU_HYPRE_MEMORY_HOST);
      }
      ...
      if ((smg_data -> num_levels) > -1)
      {
         ...
         hypre_TFree(smg_data -> relax_data_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> residual_data_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> restrict_data_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> interp_data_l, NALU_HYPRE_MEMORY_HOST);
         ...
         hypre_TFree(smg_data -> grid_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> PT_grid_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> A_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> PT_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> R_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> b_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> x_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> tb_l, NALU_HYPRE_MEMORY_HOST);
         hypre_TFree(smg_data -> tx_l, NALU_HYPRE_MEMORY_HOST);
      }

      hypre_FinalizeTiming(smg_data -> time_index);
      hypre_TFree(smg_data, NALU_HYPRE_MEMORY_HOST);
   }

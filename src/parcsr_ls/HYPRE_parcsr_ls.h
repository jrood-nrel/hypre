 ...
 *
 * See also NALU_HYPRE_BoomerAMGSetRelaxOrder.
 **/
 ...
 * For further explanation see NALU_HYPRE_FSAISetAlgoType.
 **/
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIAlgoType(NALU_HYPRE_Solver solver,
                                         NALU_HYPRE_Int    algo_type);

/**
 * (Optional) Sets the solver type for solving local linear systems in FSAI.
 * For further explanation see NALU_HYPRE_FSAISetLocalSolveType.
 **/
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAILocalSolveType( NALU_HYPRE_Solver solver,
                                                NALU_HYPRE_Int    local_solve_type );

/**
 * (Optional) Defines maximum number of steps for FSAI.
 * For further explanation see NALU_HYPRE_FSAISetMaxSteps.
 **/
 ...
 * For further explanation see NALU_HYPRE_FSAISetMaxStepSize.
 **/
 ...
 * For further explanation see NALU_HYPRE_FSAISetMaxNnzRow.
 **/
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIMaxNnzRow(NALU_HYPRE_Solver solver,
                                          NALU_HYPRE_Int    max_nnz_row);

/**
 * (Optional) Defines number of levels for computing the candidate pattern for FSAI
 * For further explanation see NALU_HYPRE_FSAISetNumLevels.
 **/
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAINumLevels(NALU_HYPRE_Solver solver,
                                          NALU_HYPRE_Int    num_levels);

/**
 * (Optional) Defines the threshold for computing the candidate pattern for FSAI
 * For further explanation see NALU_HYPRE_FSAISetThreshold.
 **/
NALU_HYPRE_Int NALU_HYPRE_BoomerAMGSetFSAIThreshold(NALU_HYPRE_Solver solver,
                                          NALU_HYPRE_Real   threshold);
 ...
 * For further explanation see NALU_HYPRE_FSAISetEigMaxIters.
 **/
 ...
 * For further explanation see NALU_HYPRE_FSAISetKapTolerance.
 **/
 ...
 *      - 2: MAGMA solver
 **/
NALU_HYPRE_Int NALU_HYPRE_FSAISetLocalSolveType( NALU_HYPRE_Solver solver,
                                       NALU_HYPRE_Int    local_solve_type );
 ...
 * type 3.
 **/
NALU_HYPRE_Int NALU_HYPRE_FSAISetMaxNnzRow( NALU_HYPRE_Solver solver,
                                  NALU_HYPRE_Int    max_nnz_row );
 ...
 * type 3.
 **/
NALU_HYPRE_Int NALU_HYPRE_FSAISetNumLevels( NALU_HYPRE_Solver solver,
                                  NALU_HYPRE_Int    num_levels );
 ...
 * type 3.
 **/
NALU_HYPRE_Int NALU_HYPRE_FSAISetThreshold( NALU_HYPRE_Solver solver,
                                  NALU_HYPRE_Real   threshold );
 ...
 *    and direct solver variants (9, 99, 199). See NALU_HYPRE_MGRSetLevelFRelaxType for details.
 **/
NALU_HYPRE_Int
 ...
 *
 *    NOTE: This function will be removed in favor of /e NALU_HYPRE_MGRSetLevelFRelaxType!!
 **/
NALU_HYPRE_Int
...
/**
 * (Optional) This function is an extension of NALU_HYPRE_MGRSetFRelaxMethod. It allows setting
 * the F-relaxation strategy for each MGR level.
 **/
NALU_HYPRE_Int
NALU_HYPRE_MGRSetLevelFRelaxMethod(NALU_HYPRE_Solver solver,
                              NALU_HYPRE_Int *relax_method );
 ...
 **/
NALU_HYPRE_Int
NALU_HYPRE_MGRSetCoarseGridMethod(NALU_HYPRE_Solver solver,
                             NALU_HYPRE_Int *cg_method );
 ...
 **/
NALU_HYPRE_Int
NALU_HYPRE_MGRSetLevelFRelaxNumFunctions(NALU_HYPRE_Solver solver,
                                    NALU_HYPRE_Int *num_functions);
...
/**
 * (Optional) This function is an extension of NALU_HYPRE_MGRSetRestrictType. It allows setting
...
/**
 * (Optional) This function is an extension of NALU_HYPRE_MGRSetInterpType. It allows setting
...
/**
 * (Optional) This function is an extension of NALU_HYPRE_MGRSetNumRelaxSweeps. It allows setting
 ...
 **/
NALU_HYPRE_Int
NALU_HYPRE_MGRGetCoarseGridConvergenceFactor( NALU_HYPRE_Solver solver,
 ...
 **/
NALU_HYPRE_Int
NALU_HYPRE_MGRSetPMaxElmts( NALU_HYPRE_Solver solver,
                       NALU_HYPRE_Int P_max_elmts );

...
dnl NALU_HYPRE Project Developers. See the top-level COPYRIGHT file for details.
dnl
...
if test "$nalu_hypre_using_fortran" = "yes" -a "x${nalu_hypre_user_chose_fflags}" = "xno"
then
   case `basename ${FC}` in

                                        ...
                                        const char           *action )
{
   ...
   NALU_HYPRE_Int      stack_elmts_max      = nalu_hypre_AuxParCSRMatrixMaxStackElmts(aux_matrix);
   NALU_HYPRE_Int      stack_elmts_current  = nalu_hypre_AuxParCSRMatrixCurrentStackElmts(aux_matrix);
   ...
   {
      NALU_HYPRE_Int stack_elmts_max_new = nalu_hypre_max(nalu_hypre_AuxParCSRMatrixUsrOnProcElmts (aux_matrix), 0) +
   ...
   nalu_hypre_AuxParCSRMatrixCurrentStackElmts(aux_matrix) += nelms;

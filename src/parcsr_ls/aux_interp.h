...
void
hypre_ParCSRCommExtendA(hypre_ParCSRMatrix *A, NALU_HYPRE_Int newoff, NALU_HYPRE_Int *found,
...
NALU_HYPRE_Int alt_insert_new_nodes(hypre_ParCSRCommPkg *comm_pkg,
...
void build_interp_colmap(hypre_ParCSRMatrix *P, NALU_HYPRE_Int full_off_procNodes,

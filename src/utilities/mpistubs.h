...
#define MPI_C_FLOAT_COMPLEX nalu_hypre_MPI_COMPLEX
#define MPI_C_LONG_DOUBLE_COMPLEX nalu_hypre_MPI_COMPLEX
...
typedef void (nalu_hypre_MPI_User_function) (void);

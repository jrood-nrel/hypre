...
typedef struct
{
   ...
   nalu_hypre_ParCSRMatrix  **B_array;    /* block diagonal inverse matrices */
   nalu_hypre_ParCSRMatrix  **B_FF_array; /* block-FF diagonal inverse matrices */
...
#define nalu_hypre_ParMGRDataBArray(data)                ((data) -> B_array)
#define nalu_hypre_ParMGRDataB(data, i)                  ((data) -> B_array[i])
#define nalu_hypre_ParMGRDataBFFArray(data)              ((data) -> B_FF_array)
#define nalu_hypre_ParMGRDataBFF(data, i)                ((data) -> B_FF_array[i])

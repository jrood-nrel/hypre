...
#define sqrt nalu_hypre_sqrt
#define log nalu_hypre_log
#define pow nalu_hypre_pow
...
#else
typedef NALU_HYPRE_Int /* Unknown procedure type */ (*U_fp)(void);
...
typedef /* Subroutine */ NALU_HYPRE_Int (*S_fp)(void);
#endif

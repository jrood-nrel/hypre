...
typedef struct
{
   ...
   NALU_HYPRE_Int              device_gs_method; /* device G-S options */
#endif
...
#define nalu_hypre_HandleStructCommRecvBuffer(nalu_hypre_handle)           ((nalu_hypre_handle) -> struct_comm_recv_buffer)
#define nalu_hypre_HandleStructCommSendBuffer(nalu_hypre_handle)           ((nalu_hypre_handle) -> struct_comm_send_buffer)
#define nalu_hypre_HandleStructCommRecvBufferSize(nalu_hypre_handle)       ((nalu_hypre_handle) -> struct_comm_recv_buffer_size)
#define nalu_hypre_HandleStructCommSendBufferSize(nalu_hypre_handle)       ((nalu_hypre_handle) -> struct_comm_send_buffer_size)
...
#define nalu_hypre_HandleVendorSolverHandle(nalu_hypre_handle)             nalu_hypre_DeviceDataVendorSolverHandle(nalu_hypre_HandleDeviceData(nalu_hypre_handle))
...
#define nalu_hypre_HandleMagmaQueue(nalu_hypre_handle)                     ((nalu_hypre_handle) -> magma_queue)

...
NALU_HYPRE_Int
nalu_hypre_ParCSRMatrixInitialize_v2( nalu_hypre_ParCSRMatrix   *matrix,
...
nalu_hypre_ParCSRMatrix*
nalu_hypre_ParCSRMatrixClone_v2(nalu_hypre_ParCSRMatrix   *A,
                           NALU_HYPRE_Int             copy_data,
                           NALU_HYPRE_MemoryLocation  memory_location)
{
   nalu_hypre_ParCSRMatrix *S;

   nalu_hypre_GpuProfilingPushRange("nalu_hypre_ParCSRMatrixClone");
...
nalu_hypre_ParCSRMatrixMigrate(nalu_hypre_ParCSRMatrix *A, NALU_HYPRE_MemoryLocation memory_location)
{
   ...
   nalu_hypre_CSRMatrixMigrate(nalu_hypre_ParCSRMatrixDiag(A), memory_location);
   nalu_hypre_CSRMatrixMigrate(nalu_hypre_ParCSRMatrixOffd(A), memory_location);
...
void
nalu_hypre_ParCSRMatrixCopyColMapOffdToHost(nalu_hypre_ParCSRMatrix *A)
{
#if defined(NALU_HYPRE_USING_GPU)
   if (nalu_hypre_ParCSRMatrixColMapOffd(A) == NULL)
   {
      const NALU_HYPRE_Int num_cols_A_offd = nalu_hypre_CSRMatrixNumCols(nalu_hypre_ParCSRMatrixOffd(A));
      nalu_hypre_ParCSRMatrixColMapOffd(A) = nalu_hypre_TAlloc(NALU_HYPRE_BigInt, num_cols_A_offd,
                                                     NALU_HYPRE_MEMORY_HOST);
      nalu_hypre_TMemcpy(nalu_hypre_ParCSRMatrixColMapOffd(A), nalu_hypre_ParCSRMatrixDeviceColMapOffd(A), NALU_HYPRE_BigInt,
                    num_cols_A_offd,

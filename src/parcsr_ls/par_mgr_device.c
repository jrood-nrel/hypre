                      ...
                      hypre_ParCSRMatrix **P_ptr)
{
   ...
   if (method > 0)
   {
      ...
      diag = hypre_CTAlloc(NALU_HYPRE_Complex, nfpoints, NALU_HYPRE_MEMORY_DEVICE);
      if (method == 1)
      {
         ...
         diag1 = hypre_CTAlloc(NALU_HYPRE_Complex, nfpoints, NALU_HYPRE_MEMORY_DEVICE);
         ...
         hypre_TFree(diag1, NALU_HYPRE_MEMORY_DEVICE);
      }
      else if (method == 2)
      {
      ...
      hypre_SeqVectorInitialize_v2(D_FF_inv, NALU_HYPRE_MEMORY_DEVICE);
   ...
   else
   {
      ...
      hypre_CSRMatrixInitialize_v2(W_diag, 0, NALU_HYPRE_MEMORY_DEVICE);
      hypre_CSRMatrixInitialize_v2(W_offd, 0, NALU_HYPRE_MEMORY_DEVICE);

...
/******************************************************************************/
/* Create function for a NALU_HYPRE_LinSysCore object.                             */
/*----------------------------------------------------------------------------*/

LinearSystemCore *NALU_HYPRE_base_create( MPI_Comm comm ) 
{
   LinearSystemCore* linSys = new NALU_HYPRE_LinSysCore(comm);
   return (linSys);
}
...
extern "C" int NALU_HYPRE_LinSysCore_create(LinSysCore** lsc, MPI_Comm comm) 
{
   NALU_HYPRE_LinSysCore* linSys = new NALU_HYPRE_LinSysCore(comm);
...
/******************************************************************************/
/* Destroy function, to de-allocate a NALU_HYPRE_LinSysCore object.                */
/*----------------------------------------------------------------------------*/

extern "C" int NALU_HYPRE_LinSysCore_destroy(LinSysCore** lsc) 
{
   if (*lsc == NULL) return(1);

   NALU_HYPRE_LinSysCore* linSys = (NALU_HYPRE_LinSysCore*)((*lsc)->lsc_);
...
extern "C" int NALU_HYPRE_LSC_BeginMappedMatrixLoad(LinSysCore* lsc) 
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_EndMappedMatrixLoad(LinSysCore* lsc) 
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_MappedMatrixLoad(LinSysCore* lsc, int row,
                int col, double val) 
{
   if (lsc == NULL) return(1);
...
extern "C" char *NALU_HYPRE_LSC_GetVersion(LinSysCore* lsc)
{
   char *lscVersion;
...
extern "C" int NALU_HYPRE_LSC_GetFEDataObject(LinSysCore* lsc, void **object)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_parameters(LinSysCore* lsc, int numParams, 
                                    char **params) 
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_setGlobalOffsets(LinSysCore* lsc, int leng, 
...
extern "C" int NALU_HYPRE_LSC_setMatrixStructure(LinSysCore *lsc, int** ptColIndices, 
...
extern "C" int NALU_HYPRE_LSC_resetMatrixAndVector(LinSysCore *lsc, double val)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_resetMatrix(LinSysCore *lsc, double val)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_resetRHSVector(LinSysCore *lsc, double val)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_sumIntoSystemMatrix(LinSysCore *lsc, int numPtRows, 
...
extern "C" int NALU_HYPRE_LSC_sumIntoRHSVector(LinSysCore *lsc, int num, 
...
extern "C" int NALU_HYPRE_LSC_matrixLoadComplete(LinSysCore *lsc)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_enforceEssentialBC(LinSysCore *lsc, int* globalEqn,
...
extern "C" int NALU_HYPRE_LSC_enforceRemoteEssBCs(LinSysCore *lsc,int numEqns,
...
extern "C" int NALU_HYPRE_LSC_enforceOtherBC(LinSysCore *lsc, int* globalEqn, 
...
extern "C" int NALU_HYPRE_LSC_getSolution(LinSysCore *lsc, double *answers, int leng)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_getSolnEntry(LinSysCore *lsc, int eqnNumber, 
                                      double *answer)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_formResidual(LinSysCore *lsc, double *values, int leng)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_launchSolver(LinSysCore *lsc, int *solveStatus, 
                                      int *iter)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_FEDataInitFields(LinSysCore *lsc, int nFields,
...
extern "C" int NALU_HYPRE_LSC_FEDataInitElemBlock(LinSysCore *lsc, int nElems,
...
extern "C" int NALU_HYPRE_LSC_FEDataInitElemNodeList(LinSysCore *lsc, int elemID,
...
extern "C" int NALU_HYPRE_LSC_FEDataInitSharedNodes(LinSysCore *lsc, int nShared,
...
extern "C" int NALU_HYPRE_LSC_FEDataInitComplete(LinSysCore *lsc)
{
   if (lsc == NULL) return(1);
...
extern "C" int NALU_HYPRE_LSC_FEDataLoadElemMatrix(LinSysCore *lsc, int elemID,

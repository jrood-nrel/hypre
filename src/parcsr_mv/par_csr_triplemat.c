...
/*--------------------------------------------------------------------------
 * nalu_hypre_ParCSRMatMatHost
 *
 * Host implementation of nalu_hypre_ParCSRMatMat (C = A * B)
 *--------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------
 * nalu_hypre_ParCSRTMatMatKTHost
 *
 * Host implementation of nalu_hypre_ParCSRTMatMatKT (C = A^T * B)
 *--------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------
 * nalu_hypre_ParCSRMatrixRAPKTHost
 *
 * Host implementation of nalu_hypre_ParCSRMatrixRAPKT
 *--------------------------------------------------------------------------*/
                             ...
                             NALU_HYPRE_Int           keep_transpose )
{
   ...
   NALU_HYPRE_BigInt          n_rows_R         = nalu_hypre_ParCSRMatrixGlobalNumRows(R);
   NALU_HYPRE_BigInt          n_cols_R         = nalu_hypre_ParCSRMatrixGlobalNumCols(R);
   nalu_hypre_CSRMatrix      *R_diag           = nalu_hypre_ParCSRMatrixDiag(R);
   nalu_hypre_CSRMatrix      *RT_diag          = nalu_hypre_ParCSRMatrixDiagT(R);
   nalu_hypre_CSRMatrix      *R_offd           = nalu_hypre_ParCSRMatrixOffd(R);
   nalu_hypre_CSRMatrix      *RT_offd          = nalu_hypre_ParCSRMatrixOffdT(R);
   ...
   nalu_hypre_CSRMatrix      *A_diag           = nalu_hypre_ParCSRMatrixDiag(A);
   nalu_hypre_CSRMatrix      *A_offd           = nalu_hypre_ParCSRMatrixOffd(A);
   NALU_HYPRE_BigInt          n_rows_A         = nalu_hypre_ParCSRMatrixGlobalNumRows(A);
   NALU_HYPRE_BigInt          n_cols_A         = nalu_hypre_ParCSRMatrixGlobalNumCols(A);
   NALU_HYPRE_BigInt         *row_starts_A     = nalu_hypre_ParCSRMatrixRowStarts(A);
   ...
   NALU_HYPRE_BigInt          n_rows_P         = nalu_hypre_ParCSRMatrixGlobalNumRows(P);
   NALU_HYPRE_BigInt          n_cols_P         = nalu_hypre_ParCSRMatrixGlobalNumCols(P);
   ...
   {
      RT_diag = nalu_hypre_ParCSRMatrixDiagT(R);
   }
   ...
   if (num_procs > 1)
   {
      ...
      if (num_cols_offd_R)
      {
         ...
         {
            RT_offd = nalu_hypre_ParCSRMatrixOffdT(R);
         }
      ...
      if (num_cols_offd_R)
      {
         ...
         if (!nalu_hypre_ParCSRMatrixOffdT(R))
         {
            if (keep_transpose)
            {
               nalu_hypre_ParCSRMatrixOffdT(R) = RT_offd;
            }
            else
            {
   ...
   if (!nalu_hypre_ParCSRMatrixDiagT(R))
   {
      if (keep_transpose)
      {
         nalu_hypre_ParCSRMatrixDiagT(R) = RT_diag;
      }
      else
      {

...
cusparseDnVecDescr_t nalu_hypre_VectorToCusparseDnVec_core(NALU_HYPRE_Complex *x_data, NALU_HYPRE_Int n);
...
cusparseDnMatDescr_t nalu_hypre_VectorToCusparseDnMat_core(NALU_HYPRE_Complex *x_data, NALU_HYPRE_Int nrow,
                                                      NALU_HYPRE_Int ncol, NALU_HYPRE_Int order);
...
NALU_HYPRE_Int nalu_hypre_SortCSRCusparse( NALU_HYPRE_Int n, NALU_HYPRE_Int m, NALU_HYPRE_Int nnzA,
...
NALU_HYPRE_Int nalu_hypre_SortCSRRocsparse( NALU_HYPRE_Int n, NALU_HYPRE_Int m, NALU_HYPRE_Int nnzA,

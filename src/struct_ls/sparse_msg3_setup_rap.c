...
/*--------------------------------------------------------------------------
 * nalu_hypre_SparseMSG3CreateRAPOp
 *    Sets up new coarse grid operator stucture.
 *--------------------------------------------------------------------------*/

nalu_hypre_StructMatrix *
nalu_hypre_SparseMSG3CreateRAPOp( nalu_hypre_StructMatrix *R,
 ...
 *
 * I've written a two routines - nalu_hypre_SparseMSG3BuildRAPSym to build the lower
 * triangular part of RAP (including the diagonal) and
 * nalu_hypre_SparseMSG3BuildRAPNoSym to build the upper triangular part of RAP
...
NALU_HYPRE_Int
nalu_hypre_SparseMSG3BuildRAPSym( nalu_hypre_StructMatrix *A,
                             nalu_hypre_StructMatrix *P,
...
NALU_HYPRE_Int
nalu_hypre_SparseMSG3BuildRAPNoSym( nalu_hypre_StructMatrix *A,
                               nalu_hypre_StructMatrix *P,
                               nalu_hypre_StructMatrix *R,
                               NALU_HYPRE_Int           cdir,
                               nalu_hypre_Index         cindex,
